...
protein_filename=/data/chodera/zhangi/perses_benchmark/repex/43/4/apo_equilibrated.pdb
ligand_input_filename=/data/chodera/zhangi/perses_benchmark/repex/43/4/complex_equilibrated.pdb
resid=83
mutant_aa=GLN
outdir=/data/chodera/zhangi/perses_benchmark/repex/47/11/replicate_1/
