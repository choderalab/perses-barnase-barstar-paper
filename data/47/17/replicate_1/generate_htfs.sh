...
protein_filename=/data/chodera/zhangi/perses_benchmark/repex/43/5/apo_equilibrated.pdb
ligand_input_filename=/data/chodera/zhangi/perses_benchmark/repex/43/5/complex_equilibrated.pdb
resid=42
mutant_aa=THR
outdir=/data/chodera/zhangi/perses_benchmark/repex/47/17/replicate_1/
