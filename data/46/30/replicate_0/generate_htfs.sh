...
protein_filename=/data/chodera/zhangi/perses_benchmark/repex/43/23/apo_equilibrated.pdb
ligand_input_filename=None
resid=2
mutant_aa=TYR
outdir=/data/chodera/zhangi/perses_benchmark/repex/46/30/replicate_0/
