...
protein_filename=/data/chodera/zhangi/perses_benchmark/repex/43/24/apo_equilibrated.pdb
ligand_input_filename=None
resid=2
mutant_aa=ARG
outdir=/data/chodera/zhangi/perses_benchmark/repex/46/38/replicate_0/
