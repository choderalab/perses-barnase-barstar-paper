...
protein_filename=/data/chodera/zhangi/perses_benchmark/repex/43/19/apo_equilibrated.pdb
ligand_input_filename=None
resid=2
mutant_aa=ALA
outdir=/data/chodera/zhangi/perses_benchmark/repex/46/24/replicate_0/
