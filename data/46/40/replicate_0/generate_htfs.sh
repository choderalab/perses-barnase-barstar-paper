...
protein_filename=/data/chodera/zhangi/perses_benchmark/repex/43/38/apo_equilibrated.pdb
ligand_input_filename=None
resid=2
mutant_aa=ALA
old_residue=ASH
outdir=/data/chodera/zhangi/perses_benchmark/repex/46/40/replicate_0/
