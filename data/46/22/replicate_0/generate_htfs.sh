...
protein_filename=/data/chodera/zhangi/perses_benchmark/repex/43/16/apo_equilibrated.pdb
ligand_input_filename=None
resid=2
mutant_aa=PHE
outdir=/data/chodera/zhangi/perses_benchmark/repex/46/22/replicate_0/
