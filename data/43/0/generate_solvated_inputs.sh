...
protein_filename=/data/chodera/zhangi/perses_benchmark/perses-barnase-barstar-paper/input_files/ALA_capped.pdb
outdir=/data/chodera/zhangi/perses_benchmark/repex/43/0/
