...
protein_filename=/data/chodera/zhangi/perses_benchmark/perses-barnase-barstar-paper/input_files/1brs_barstar_A42.pdb
outdir=/data/chodera/zhangi/perses_benchmark/repex/43/5/
